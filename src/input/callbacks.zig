...
pub fn scroll(_: glfw.Window, x: f64, y: f64) void {
    ...
    game.state.controls.mouse.scroll.x = std.math.clamp(game.state.controls.mouse.scroll.x, 0.0, 100.0);
    game.state.controls.mouse.scroll.y = std.math.clamp(game.state.controls.mouse.scroll.y, 0.0, 100.0);
